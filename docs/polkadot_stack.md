...
| Block Explorers | [Polkascan](https://github.com/polkascan/explorer-api) :red_circle:, [Polkastats](https://github.com/Colm3na/polkastats-backend) :red_circle:, [Subscan](https://github.com/itering/subscan) :red_circle:, [Statescan](https://github.com/opensquare-network/statescan) :red_circle:, [Edgscan](https://github.com/edgeware-builders/edgscan) :red_circle:| Ink Smart Contract Explorer, Mempool focused explorer (including parachain transaction)
...
| IoT | [Nodle](https://github.com/NodleCode/chain) :yellow_circle:, [MXC/DataHighway](https://github.com/DataHighway-DHX/node) :red_circle:, [peaq-network-node](https://github.com/peaqnetwork/peaq-network-node) :green_circle:
| Verifiable Claims | [KILT](https://github.com/KILTprotocol/kilt-node) :green_circle:, [Dock](https://github.com/docknetwork/dock-substrate) :yellow_circle:, [Fennel Protocol](https://github.com/fennelLabs/Fennel-Protocol) :red_circle:
| Supply chain| | | 
| Health care| [AriaHealth](https://github.com/AriaHealth/MetaNetwork) :grey_question:| | 
| Social Networking | [Social Network](https://github.com/social-network/blockchain) :red_circle:, [SubSocial](https://github.com/dappforce/subsocial-node) :red_circle:, [ZeroDAO](https://github.com/ZeroDAO/ZeroDAO-node) :red_circle:, [Myriad Node](https://github.com/myriadsocial/myriad-node) :red_circle:, [Wika Network](https://github.com/randombishop/wika_etl) :red_circle:, [Project Liberty](https://github.com/LibertyDSNP/mrc) :green_circle:| Private instant messenger that uses on-chain identity
...
| Enable specific use-cases | [Robonomics](https://github.com/airalab/substrate-node-robonomics) :red_circle:, [UniversalDOT](https://github.com/UniversalDot/pallets) :red_circle:, [Evercity Sustainable Finance Protocol](https://github.com/EvercityEcosystem/evercity-chain) :red_circle:, [Fennel Protocol](https://github.com/fennelLabs/Fennel-Protocol) :red_circle:, [logion](https://github.com/logion-network/logion-node) :red_circle:
